 ...
 * Plugin Name: GitBoss
 * Version: 1.2
 * Author: Loui Byrdziak
 * Author URI: https://www.gitboss.com
 * License: GPL2
 * Description: Hire a GitBoss certified developer. Make your website developement easy.
 * Text Domain: gitboss
 * Domain Path: /languages/
 */
/*  Copyright 2015-2016 GitBoss
...
require_once __DIR__ . '/inc/class-gitboss-requirements.php';
require_once __DIR__ . '/inc/class-gitboss-admin.php';
require_once __DIR__ . '/inc/class-gitboss-help.php';
require_once __DIR__ . '/inc/class-gitboss-menu.php';
require_once __DIR__ . '/inc/class-gitboss-menu-bubble.php';
require_once __DIR__ . '/inc/class-gitboss-submenu-configure.php';
require_once __DIR__ . '/inc/class-gitboss-submenu-status.php';
require_once __DIR__ . '/inc/class-gitboss-submenu-commits.php';
require_once __DIR__ . '/inc/class-gitboss-submenu-settings.php';

function gitium_load_textdomain() {
	load_plugin_textdomain( 'gitboss', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
