...
<?php foreach ( $reviews as $review ) { ?>
	<div class="at-tour-reviews__item">
		...
		<div class="at-tour-reviews__item__info">
			...
			<h3 class="at-tour-reviews__item__title"><a href="<?php echo esc_url( get_permalink( $review->ID ) ); ?>"><?php echo esc_html( $review->post_title ); ?></a></h3>
		</div>
		<div class="at-tour-reviews__item__description"><?php echo esc_html( $review->comment_content ); ?></div>
	</div>
<?php } ?>
</div>
