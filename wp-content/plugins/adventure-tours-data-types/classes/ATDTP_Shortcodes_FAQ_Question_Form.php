	...
	public static function getMessageText( $messageCode ) {
		...
		if ( ! $defaultMessages ) {
			$defaultMessages = array(
				'nonce_is_invalid' => __( 'Please reload the page and resubmit the form again.', 'adventure-tours-data-types' ),
				'question_has_been_sent' => __( 'Your question has been submitted successfully.', 'adventure-tours-data-types' ),
				'question_submit_is_fail' => __( 'Your question has not been submitted. Please contact support.', 'adventure-tours-data-types' ),
				'unknown_validation_error' => __( 'Please fill in all required fields.', 'adventure-tours-data-types' ),
				'complete_required_field' => __( 'Fill in the required field.', 'adventure-tours-data-types' ),
				'check_email_address_field' => __( 'Email invalid.', 'adventure-tours-data-types' ),
				'default_notification_subject' => __( 'FAQs: new question', 'adventure-tours-data-types' ),
			);
		}
