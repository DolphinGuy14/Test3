...
if ( ! function_exists( 'adventure_tours_comment_form_renderer' ) ) {
	...
	function adventure_tours_comment_form_renderer() {
		...
		echo str_replace( '<input name="submit" type="submit" id="submit" class="submit" value="" />','<button type="submit" class="button button--style1 button--with-icon"><i class="fa fa-comment"></i>' . esc_html__( 'Post Comment', 'adventure-tours' ) . '</button>', $formHtml );
	}
}
