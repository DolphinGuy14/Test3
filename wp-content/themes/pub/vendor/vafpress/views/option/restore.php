	...
	<div class="field">
		<div class="input">
			<div class="buttons">
				...
				<p><?php 
					//_e('** Please make sure you have already make a backup data of your current settings. Once you click this button, your current settings will be gone.', 'vp_textdomain');
					_e('** Please make sure that you have a backup copy of your current settings. Once you click this button, your current settings will be gone.', 'vp_textdomain'); ?></p>
