...
$authorId = $settings['show_categories'] ? get_the_author_meta( 'ID' ) : null;
...
<ul class="article-info padding-left padding-right">
	...
	<?php if ( $hasComments ) { ?><li><i class="fa fa-comments-o"></i><?php comments_popup_link( __( 'No Comments', 'adventure-tours' ), __( '1 Comment', 'adventure-tours' ), __( '% Comments', 'adventure-tours' ) ); ?></li><?php } ?>
</ul>
