...
<div id="comments" class="tour-reviews margin-top">
	...
	<?php else : ?>
		<p class="woocommerce-noreviews padding-all"><?php _e( 'There are no reviews yet.', 'adventure-tours' ); ?></p>
	<?php endif; ?>
	</div>
	...
	<?php else : ?>
		<p class="woocommerce-verification-required padding-left padding-right padding-bottom"><?php _e( 'Only logged in customers who have purchased this product may leave a review.', 'adventure-tours' ); ?></p>
	<?php endif; ?>
</div>
