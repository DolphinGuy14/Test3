...
class WC_Admin_Attributes_Extended extends TdComponent
{
	...
	public function hook() {
		...
		add_submenu_page( $this->parent_page_slug, __( 'Attributes', 'woocommerce' ), __( 'Attributes', 'woocommerce' ), 'manage_product_terms', $this->extended_page_slug, array( $this, 'render_page' ) );
	...
	protected function load_assets() {
		...
		wp_localize_script( 'td-taxonomy-fiels-icons-chooser', 'td_icon_placeholder', __( 'None', 'adventure-tours' ) );
	}

	public function get_options_list() {
		$result = array( 
			'none' => __( 'None', 'adventure-tours' )
		);
