...
class AtThemeCustomizer extends TdComponent
{
	...
	public function getCustomazerSettings() {
		...
		return array(
			'typography' => array(
				'config' => array(
					'title' => __( 'Typography', 'adventure-tours' ),
				),
				'fields' => array(
					'main_font' => array(
						'label' => __( 'Main Font', 'adventure-tours' ),
						'field_type' => 'themedelight_font',
						'default' => $this->getFontSettingDefaults( 'main_font' ),
					),
					'main_font_size' => array(
						'label' => __( 'Size', 'adventure-tours' ),
						'as_subfield' => true,
					...
					'main_font_color' => array(
						'label' => __( 'Main Font Color', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#333333',
					),
					'subheading_font' => array(
						'label' => __( 'Subheading Font', 'adventure-tours' ),
						'field_type' => 'themedelight_font',
						'default' => $this->getFontSettingDefaults( 'subheading_font' ),
					),
					'alternative_text_font' => array(
						'label' => __( 'Alternative Text Font', 'adventure-tours' ),
						'field_type' => 'themedelight_font',
						'default' => $this->getFontSettingDefaults( 'alternative_text_font' ),
					),
					'heading_font' => array(
						'label' => __( 'Heading Font', 'adventure-tours' ),
						'field_type' => 'themedelight_font',
						'default' => $this->getFontSettingDefaults( 'heading_font' ),
					),
					'links_color' => array(
						'label' => __( 'Link Color', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#4090e5',
					),
				),
			...
			'general' => array(
				'config' => array(
					'title' => __( 'General Colors', 'adventure-tours' ),
				),
				'fields' => array(
					'main_color' => array(
						'label' => __( 'Main color', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#47a0ff',
					),
					'accent_color1' => array(
						'label' => __( 'Accent color 1', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#ff47a0',
					),
					'accent_color2' => array(
						'label' => __( 'Accent color 2', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#01cb68',
					),
					'forms_bg' => array(
						'label' => __( 'Form background', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#47a0ff',
					),
					'forms_button_bg' => array(
						'label' => __( 'Form button background', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#006fe6',
					),
				),
			...
			'header' => array(
				'config' => array(
					'title' => __( 'Header Colors', 'adventure-tours' ),
				),
				'fields' => array(
					'header_bg' => array(
						'label' => __( 'Background color', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#334960',
					),
					'header_text_color' => array(
						'label' => __( 'Text color', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#ffffff',
					),
				),
			...
			'footer' => array(
				'config' => array(
					'title' => __( 'Footer Colors', 'adventure-tours' ),
				),
				'fields' => array(
					'footer_bg' => array(
						'label' => __( 'Background color', 'adventure-tours' ),
					...
					'footer_heading_color' => array(
						'label' => __( 'Heading color', 'adventure-tours' ),
						'field_type' => 'color',
						'default' => '#ffffff',
					),
